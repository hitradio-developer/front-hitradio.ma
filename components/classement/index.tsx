                    ...
                    <div className="sm:col-span-2 lg:col-span-4">
                        <div className="flex items-start mb-3 pb-3">
                            ...
                            <a href="#" className="inline-block mr-3">
                                <div className="max-w-[110px] bg-cover bg-center relative shadow-lg" >
                        ...
                        <div className="flex items-start mb-3 pb-3">
                            ...
                            <a href="#" className="inline-block mr-3">
                                <div className="max-w-[110px] bg-cover bg-center relative" >
                                <Image className="w-full relative z-0 rounded-lg transition-all duration-300 h-[94px]"
                                src={Video1} alt="Picture ofmehdi the Videos" />
                                </div>
                            </a>
                            <div className="text-sm">
                                <a href="#" className="text-gray-900 font-medium hover:text-indigo-600 leading-none">JEADY JAY HOLY FADA.</a>
