        ...
        <div className="container mx-auto px-2">
            ...
            <div className="w-full overflow-hidden relative">
                ...
                style={{ width: 'fit-content', animation: 'carouselAnim 10s infinite alternate linear' }}>
                    ...
                    <div className="carousel-focus flex items-center flex-col relative mx-5 my-10 px-4 py-3 rounded-lg shadow-lg"  style={{ width: '200px' }}>   
                    ...
                    <div className="carousel-focus flex items-center flex-col relative mx-5 my-4 px-4 py-3 rounded-lg shadow-lg" style={{ width: '200px' }}>
